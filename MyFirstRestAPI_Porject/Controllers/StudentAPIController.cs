...
namespace StudentApi.Controllers 
{
    ...
    public class StudentsController : ControllerBase // Declare the controller class inheriting from ControllerBase.
    {
        ...
        {
            if (id < 1 || updatedStudent is { Name: null or "" } || updatedStudent.Age < 7 || updatedStudent.Grade < 0)
            {
                return BadRequest("Invalid student data.");
            }
            ...
            student.Age = updatedStudent?.Age ?? 0;
            student.Grade = updatedStudent?.Grade ?? 0;
